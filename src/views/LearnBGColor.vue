                ...
                <div class="flex flex-col gap-3 w-full sm:w-full md:w-[60%] lg:w-[60%]">
                        ...
                        <div class="h-[55vh] border-2 mt-2 rounded-lg border-gray-500 text-white p-2 flex-col flex">
                            ...
                            <div class="p-0 text-xs">
                                ...
                                &lt;h2 <span class="text-yellow-500 font-bold">style="background-color:
                                    yellow;"</span>&gt;Sample&lt;/h2&gt; <br>
                                &lt;p <span class="text-yellow-500 font-bold">style="background-color:
                                    green;"</span>&gt;Sample&lt;/p&gt; <br>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex gap-2">
                            ...
                            <button class="rounded-lg p-2 h-12 font-bold mt-2 bg-[#0ed494]" @click="goToTextColorPage">
                                <Icon icon="fluent:previous-16-filled" height="20" />
                            </button>
                            <button class="bg-[#0ed494] rounded-lg p-2 h-12 font-bold mt-2" @click="goToFontSizePage">
